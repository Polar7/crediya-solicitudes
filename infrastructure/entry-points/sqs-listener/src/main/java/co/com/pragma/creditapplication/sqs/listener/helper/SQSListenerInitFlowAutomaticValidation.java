...
@Log4j2
@Builder
public class SQSListenerInitFlowAutomaticValidation {
    private final SqsAsyncClient client;
    private final SQSProperties properties;
    private final Function<Message, Mono<Void>> processor;
    private String operation;

    public SQSListenerInitFlowAutomaticValidation start() {
        this.operation = "MessageFrom:" + properties.queueInitFlowAutomaticValidationUrl();
    ...
    private ReceiveMessageRequest getReceiveMessageRequest() {
        return ReceiveMessageRequest.builder()
                .queueUrl(properties.queueInitFlowAutomaticValidationUrl())
