...
@Log4j2
@Builder
public class SQSListenerCalculateDebtCapacityResponse {
    private final SqsAsyncClient client;
    private final SQSProperties properties;
    private final Function<Message, Mono<Void>> processor;
    private String operation;

    public SQSListenerCalculateDebtCapacityResponse start() {
        this.operation = "MessageFrom:" + properties.queueCalculateDebtCapacityResponseUrl();
    ...
    private ReceiveMessageRequest getReceiveMessageRequest() {
        return ReceiveMessageRequest.builder()
                .queueUrl(properties.queueCalculateDebtCapacityResponseUrl())
