...
class SQSConfigTest {
    ...
    void init() {
        ...
        when(sqsProperties.queueInitFlowAutomaticValidationUrl()).thenReturn("http://localhost:4566/00000000000/queue-sqs");
    ...
    @Test
    void configSQSListenerInitFlowAutomaticValidationIsNotNull() {
        assertThat(sqsConfig.sqsListenerInitFlowAutomaticValidation(sqsAsyncClient, sqsProperties, message -> Mono.empty())).isNotNull();
    }
